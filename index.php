<?php
	...
	//	$cabang = .....
	$cabang= array("Harmoni", "Sarinah","Grogol", "Senanyan","Pluit","Cempaka");
...
<html>
		...
		<form action="index.php" method="post" id="formPemesanan">
			<div class="row">
				...
				<div class="col-lg-2">
					...
					<option value=""> Senayan </option>
					<option value=""> Pluit </option>
					...
					<?php
						...
						//	.....
						$cabang = array(
							array("cabang" => "Harmoni"),
							array("cabang" => "Sarinah"),
							array("cabang" => "Grogol"),
							array("cabang" => "Senayan"),
							array("cabang" => "Pluit"),
							array("cabang" => "Cempaka"),
						  );
	...
	<?php
		...
		if(isset($_POST['Pesan'])) {
			...
			$diskon = ($tagihanAwal >= 1000000) ? (0.05 * $tagihanAwal) : 0;
